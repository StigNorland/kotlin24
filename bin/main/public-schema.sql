...
DROP TABLE agency;
CREATE TABLE agency (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE NOT NULL, name CHARACTER VARYING(50), PRIMARY KEY (id));
DROP TABLE author;
CREATE TABLE author (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, about CHARACTER VARYING(500), authors_affiliation CHARACTER VARYING(255), email CHARACTER VARYING(255), homepage CHARACTER VARYING(255), name CHARACTER VARYING(70) NOT NULL, picture CHARACTER VARYING(255), modified_by_id UUID NOT NULL, PRIMARY KEY (id));
DROP TABLE authority;
CREATE TABLE authority (id UUID NOT NULL, authority CHARACTER VARYING(255), name CHARACTER VARYING(255), PRIMARY KEY (id));
DROP TABLE category;
CREATE TABLE category (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), category_kind CHARACTER VARYING(255) NOT NULL, classification_level CHARACTER VARYING(255), description CHARACTER VARYING(2000), format CHARACTER VARYING(255), hierarchy_level CHARACTER VARYING(255) NOT NULL, maximum CHARACTER VARYING(255), minimum CHARACTER VARYING(255), label CHARACTER VARYING(255), modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, PRIMARY KEY (id), CONSTRAINT unq_category_name_kind UNIQUE (label, name, category_kind));
...
DROP TABLE comment;
CREATE TABLE comment (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, comment CHARACTER VARYING(2000), is_public BOOLEAN DEFAULT true NOT NULL, owner_id UUID NOT NULL, modified_by_id UUID NOT NULL, owner_idx INTEGER, PRIMARY KEY (id));
DROP TABLE concept;
CREATE TABLE concept (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(10000), is_archived BOOLEAN NOT NULL, label CHARACTER VARYING(255), topicgroup_id UUID, modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, concept_id UUID, PRIMARY KEY (id));
...
CREATE TABLE instruction (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(255), modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, PRIMARY KEY (id), CONSTRAINT unq_instruction_name UNIQUE (name, description, agency_id));
DROP TABLE instrument;
CREATE TABLE instrument (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(255), external_instrument_location CHARACTER VARYING(255), instrument_kind CHARACTER VARYING(255), label CHARACTER VARYING(255), modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, study_id UUID, PRIMARY KEY (id));
...
CREATE TABLE publication (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), purpose CHARACTER VARYING(255), modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, status_id BIGINT NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE question_item (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), intent CHARACTER VARYING(3000), question CHARACTER VARYING(2000), responsedomain_name CHARACTER VARYING(255), responsedomain_revision INTEGER, responsedomain_id UUID, modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, PRIMARY KEY (id));
DROP TABLE responsedomain;
CREATE TABLE responsedomain (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(2000) NOT NULL, display_layout CHARACTER VARYING(255), maximum CHARACTER VARYING(255), minimum CHARACTER VARYING(255), response_kind CHARACTER VARYING(255), schema_id UUID, modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, category_id UUID, PRIMARY KEY (id), CONSTRAINT unq_responsedomain_name UNIQUE (name, category_id, based_on_object), CONSTRAINT uk_9e2u4i28e05b8bxk0wupa6d4t UNIQUE (schema_id));
DROP TABLE revinfo;
CREATE TABLE revinfo (id INTEGER NOT NULL, timestamp BIGINT NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, modified_by_id UUID NOT NULL, PRIMARY KEY (id));
DROP TABLE study;
CREATE TABLE study (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(10000), is_archived BOOLEAN, modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, survey_id UUID, PRIMARY KEY (id));
...
CREATE TABLE survey_program (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(10000), is_archived BOOLEAN NOT NULL, modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE topic_group (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(10000), is_archived BOOLEAN NOT NULL, study_id UUID, modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, PRIMARY KEY (id));
...
DROP TABLE universe;
CREATE TABLE universe (id UUID NOT NULL, modified TIMESTAMP(6) WITHOUT TIME ZONE, based_on_object UUID, based_on_revision INTEGER, change_comment CHARACTER VARYING(255) NOT NULL, change_kind CHARACTER VARYING(255) NOT NULL, name CHARACTER VARYING(255), major INTEGER, minor INTEGER, version_label CHARACTER VARYING(255), xml_lang CHARACTER VARYING(255), description CHARACTER VARYING(2000) NOT NULL, modified_by_id UUID NOT NULL, agency_id UUID NOT NULL, PRIMARY KEY (id), CONSTRAINT unq_universe_name UNIQUE (name, description, agency_id));
DROP TABLE user_account;
CREATE TABLE user_account (id UUID NOT NULL, email CHARACTER VARYING(255), is_enabled BOOLEAN, modified TIMESTAMP(6) WITHOUT TIME ZONE, username CHARACTER VARYING(255), password CHARACTER VARYING(255), agency_id UUID, PRIMARY KEY (id), CONSTRAINT unq_user_email UNIQUE (email));
DROP TABLE user_authority;
CREATE TABLE user_authority (modified_by_id UUID NOT NULL, authority_id UUID NOT NULL, PRIMARY KEY (modified_by_id, authority_id));
ALTER TABLE "author" ADD CONSTRAINT fk72nss70nw66j9as1wx036rqnm FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
ALTER TABLE "category" ADD CONSTRAINT fkbnlig6nw8akrv8ahcejixu6kp FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "comment" ADD CONSTRAINT fk3y3uou7na66pfn512byon549s FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
ALTER TABLE "comment" ADD CONSTRAINT fkqy57xx05jqnmfho4al644sq0l FOREIGN KEY ("owner_id") REFERENCES "instruction" ("id");
ALTER TABLE "concept" ADD CONSTRAINT fkf057337a833aq1fypxk7716sn FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "control_construct" ADD CONSTRAINT fk823dk0xscu6a8j6o5yp94jrhl FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "publication" ADD CONSTRAINT fkeaeoql2u1x4t096c99ovgs2fx FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "publication_status" ADD CONSTRAINT fkga3xbi284j3pagu855c7n2xl8 FOREIGN KEY (parent_id) REFERENCES "publication_status" ("id");
ALTER TABLE "question_item" ADD CONSTRAINT fkpt2rd9pyc03ylujdb9uskta46 FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
ALTER TABLE "question_item" ADD CONSTRAINT fkqlxw0sdme1sym0v5tqf3a48hv FOREIGN KEY ("agency_id") REFERENCES "agency" ("id");
ALTER TABLE "responsedomain" ADD CONSTRAINT fk2c3ljdyvxovpj3y31e9129i0u FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "revinfo" ADD CONSTRAINT fk9q8k0vbdm1m4gneoxkjt9oqyq FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
ALTER TABLE "study" ADD CONSTRAINT fkfe9ceqica2qaks8r48xv6ufh5 FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "survey_program" ADD CONSTRAINT fkdrsjm3c773rcm4b6esuas4v7n FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "topic_group" ADD CONSTRAINT fkiadqxywk6cvnkeppe29x4o2nh FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "universe" ADD CONSTRAINT fkcgtm3ov5pfuqphjiioed8unkn FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
...
ALTER TABLE "user_authority" ADD CONSTRAINT fkn48a3n0mb8d8njshjf75kgsv FOREIGN KEY ("modified_by_id") REFERENCES "user_account" ("id");
